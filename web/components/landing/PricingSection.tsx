        ...
        <div id="pricing" className="bg-slate-50 dark:bg-black/20 py-24 border-t border-slate-200 dark:border-slate-800 overflow-hidden">
            ...
            {showSuccessModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    ...
                    >
                        <div className="absolute -top-12 -left-12 w-32 h-32 bg-sh-primary/20 rounded-full blur-3xl pointer-events-none" />
                        ...
                        <div className="relative z-10">
                                ...
                                <div className="h-16 w-16 rounded-full bg-sh-primary/10 flex items-center justify-center shadow-md">
                                    <CheckCircle aria-hidden="true" className="h-8 w-8 text-sh-primary" />
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 w-full h-10 rounded-xl border-2 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-semibold text-sm transition-all hover:border-sh-primary hover:text-sh-primary"
                            >
            ...
            <div className="layout-container max-w-7xl mx-auto px-4 md:px-10">
                ...
                >
                    ...
                    <motion.div variants={cardVariants} className="rounded-2xl bg-white dark:bg-slate-800 p-8 border border-slate-200 dark:border-slate-700 flex flex-col hover:border-slate-300 dark:hover:border-slate-600 transition-colors h-full">
                        ...
                        <ul className="space-y-4 mb-8 flex-1">
                            <li className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-300">
                                <CheckCircle aria-hidden="true" className="text-slate-400 dark:text-slate-500 h-5 w-5 shrink-0" />
                    ...
                    <motion.div variants={cardVariants} className="relative rounded-2xl bg-white dark:bg-slate-800 p-8 border-2 border-sh-primary flex flex-col shadow-xl shadow-sh-primary/10 transform lg:-translate-y-4 h-full">
                        ...
                        <ul className="space-y-4 mb-8 flex-1">
                            <li className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-300">
                                <CheckCircle aria-hidden="true" className="text-sh-primary h-5 w-5 shrink-0" />
                        ...
                        >
                            {isUnlocking === 'monthly' ? (
                                <><Loader2 aria-hidden="true" className="h-5 w-5 animate-spin" /> Processing...</>
                            ) : (
                    ...
                    {/* Pro Plan - 6 Months */}
                    <motion.div variants={cardVariants} className="relative rounded-2xl bg-sh-primary-dark p-8 border-2 border-sh-primary-dark flex flex-col shadow-xl shadow-sh-primary/30 h-full">
                        <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-white text-sh-primary-dark px-4 py-1 rounded-full text-xs font-black uppercase tracking-wide shadow-md whitespace-nowrap">
                            Best Value 🔥
                        </div>
                        ...
                        <ul className="space-y-4 mb-8 flex-1">
                            <li className="flex items-start gap-3 text-sm text-white/90">
                                <CheckCircle aria-hidden="true" className="text-emerald-300 h-5 w-5 shrink-0" />
                        ...
                        <button
                            ...
                            disabled={isUnlocking !== null}
                            className="flex items-center justify-center gap-2 w-full h-12 rounded-lg bg-white hover:bg-slate-100 text-sh-primary font-black shadow-lg transition-all disabled:opacity-70 group mt-auto"
                        >
                            {isUnlocking === '6month' ? (
                                <><Loader2 aria-hidden="true" className="h-5 w-5 animate-spin" /> Processing...</>
                            ) : (
